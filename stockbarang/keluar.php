                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            <input type="text" name="kodekaryawan" value="<?=$kodekaryawan;?>" class="form-control" required>
                                            <br>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <br>
                                            <br>
                                            <button type="submit" class="btn btn-danger" name="hapusbarangkeluarr">Hapus</Button>
                                        </div>
                                        </form>
      ...
      <div class="modal-body">
       <select name="barangnya" class="form-control">
        <?php
         ...
         <br>
         <input type="text" name="kodekaryawan"  class="form-control" placeholder="Kode Karyawan" required>
        <br>
